...
const instruments = [
  ...
  {
    id: 2,
    img: 'https://static.dnipro-m.ua/cache/products/5728/catalog_origin_257500.jpg',
    name: 'Перфоратор',
    price: 3948,
    description:
...
const serch = document.querySelector('.js-serch');
...
function createMarkup(arr) {
  const markup = arr
    .map(
      ({ id, img, name }) => `<li data-id="${id}" class = "card js-card">
